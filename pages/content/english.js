...
export default function Coursess() {
    const [videolinks, setVideoLinks] = useState(`https://www.youtube.com/embed/n-uTwzzVnsg`)
                                                            ...
                                                            <AccordionBody accordionId="1">
                                                                {DataEnglish1.map((video => (
                                                                    <>
                                                                        <li key={video.ID}>
                                                                            <Alert color="dark" >
                                                                                <b onClick={(e) => setVideoLinks(video.videoLink)} >#<span>{video.ID} </span> {video.videoTitle} </b>
                                                                            </Alert>
                                                                        </li>
                                                            ...
                                                            <AccordionBody accordionId="2">
                                                                {EnglishData3.map((video => (
                                                                    <>
                                                                        <li key={video.ID}>
                                                                            <Alert color="dark" >
                                                                                <b onClick={(e) => setVideoLinks(video.videoLink)} >#<span>{video.ID} </span> {video.videoTittle} </b>
                                                                            </Alert>
                                                                        </li>
